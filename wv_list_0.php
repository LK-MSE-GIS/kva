...
<h2>Werkverträge (bei Verm.-Stelle)</h2>

<?php

  $query="SELECT oid as id,box(the_geom) as box,bezeichnung,vermessungsstelle,abgabe,status from fd_wv where status='0' ORDER BY bezeichnung;";
