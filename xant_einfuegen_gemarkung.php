...
if ($checkr=mysqli_fetch_array($checkresult))
 ...
 /*--------------EINTRAGUNG IN ANTRAG---------------*/
 
       $query="INSERT INTO antrag (lk,number,year,vermst_id,vermart_id,ueb_datum,az,sv,aktort_id,hurry,ueb_aen)
VALUES
('$lk','$number','$year','$vermst_id','$vermart_id','$ueb_datum','$az','$sv','$aktort_id','0','$ueb_aen');";

       mysqli_query($db_link,$query) OR DIE ("Der Antrag konnte nicht angelegt werden...");
