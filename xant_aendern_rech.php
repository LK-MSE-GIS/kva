...
<td colspan=\"3\"><textarea name=\"re_unterl1\" cols=\"69\" rows=\"5\">$r[re_unterl1]</textarea></td>
  ...
  echo " <tr>
 <td colspan=\"3\" bgcolor=\"#A3A39E\"> <input type=\"Submit\" name=\"\" value=\"Änderungen eintragen\">&nbsp;&nbsp;<input type=\"reset\">&nbsp;
 </td>";
...
<tr>
 <td><input type=\"date\" name=\"re_rech2\" value=\"$r[re_rech2]\" size=\"10\" maxlength=\"10\"><a href=\"set_date.php?id=$r[id]&script=xant_aendern_rech.php&table=antrag_extra&column=re_rech2&page=$page&status=$status\"><img src=\"images/buttons/b_calendar.png\" alt=\"aktuelles Datum eintragen\" border=\"0\"></a> </td>
...
<tr>
 <td><input type=\"date\" name=\"re_rech3\" value=\"$r[re_rech3]\" size=\"10\" maxlength=\"10\"><a href=\"set_date.php?id=$r[id]&script=xant_aendern_rech.php&table=antrag_extra&column=re_rech3&page=$page&status=$status\"><img src=\"images/buttons/b_calendar.png\" alt=\"aktuelles Datum eintragen\" border=\"0\"></a> </td>
...
<tr>
 <td><input type=\"date\" name=\"re_rech4\" value=\"$r[re_rech4]\" size=\"10\" maxlength=\"10\"><a href=\"set_date.php?id=$r[id]&script=xant_aendern_rech.php&table=antrag_extra&column=re_rech4&page=$page&status=$status\"><img src=\"images/buttons/b_calendar.png\" alt=\"aktuelles Datum eintragen\" border=\"0\"></a> </td>
...
<tr>
 <td><input type=\"date\" name=\"re_rech5\" value=\"$r[re_rech5]\" size=\"10\" maxlength=\"10\"><a href=\"set_date.php?id=$r[id]&script=xant_aendern_rech.php&table=antrag_extra&column=re_rech5&page=$page&status=$status\"><img src=\"images/buttons/b_calendar.png\" alt=\"aktuelles Datum eintragen\" border=\"0\"></a> </td>
...
echo "</form></div></div>";
echo "<a href=\"xant_searchlist.php?page=$page&highlight=$id\"><img src=\"images/buttons/back.png\" alt=\"Zur&uuml;ck zur aktuellen Suche\" border=\"0\" width=\"120\"></a>&nbsp;&nbsp;";
echo "<br><div align=\"center\">";

echo "<a href=\"xant_aendern_rech.php?id=$vorgaenger&page=$page\"><img src=\"images/buttons/pfeil_links.png\" alt=\"\" border=\"0\" width=\"80\"></a>&nbsp;&nbsp;
 <a href=\"xant_aendern_rech.php?id=$nachfolger&page=$page\"><img src=\"images/buttons/pfeil_rechts.png\" alt=\"\" border=\"0\" width=\"80\"></a></a></a></div><br> <br> ";
