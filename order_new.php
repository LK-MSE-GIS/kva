...
<form action="order_insert.php" method="post" target="">
<?php
echo " <input type=hidden name=\"order_key\" value=\"$key\">";
?>
<h3>Neuer Auftrag:&nbsp;&nbsp;<?php echo "$key"?></h3>
<table>
<tr>
<td valign="top">
<table border="0">
...
<td><input type="Text" name="order_person" value="" size="40" maxlength="40"></td>
</tr>
<tr>
<td>Stra&szlig;e:</td>
<td><input type="Text" name="order_street" value="" size="40" maxlength="40"></td>
</tr>
<tr>
<td>PLZ:</td>
<td><input type="Text" name="order_plz" value="" size="7" maxlength="7"></td>
</tr>
<tr>
<td>Ort:</td>
<td><input type="Text" name="order_town" value="" size="40" maxlength="40"></td>
</tr>
<tr>
<td colspan="2">&nbsp;</td>
</tr>
...
<td><input type="date" name="delivery_date" value="" size="12" maxlength="12"></td>
</tr>
<tr>
<td>Rechnungsnr.:</td>
...
<td><input type="float" name="calc_amount" value="" size="12" maxlength="12"></td>
</tr>
<tr>
<td>Vorkasse:</td>
...
<option value="1" selected>eingegangen</option>
...
<br>Kommentar:<br>
<textarea name="order_comment" cols="80" rows="3"></textarea>
<br>
<br>
