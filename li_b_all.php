...
$nextpage=$page+1;
$prevpage=$page-1;
if ($page >0) echo "<a href=\"li_b_all.php?page=$prevpage&all=$all\"><img src=\"images/buttons/pfeil_links.png\" alt=\"\" border=\"0\" width=\"120\"></a>";
echo "</td><td>";
if ($page < $maxpage) echo "<a href=\"li_b_all.php?page=$nextpage&all=$all\"><img src=\"images/buttons/pfeil_rechts.png\" alt=\"\" border=\"0\" width=\"120\"></a>";
echo "</td>";
bottom();
?>