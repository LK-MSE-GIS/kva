...
$wms_call=URL."cgi-bin/mapserv?map=/data/wms/kva.map&request=getMap&VERSION=1.1.0&layers=DTK,Fluren,Baustellen&width=600&height=600&FORMAT=image/png&SRS=EPSG:2398&BBOX=".$lu_rechts.",".$lu_hoch.",".$ro_rechts.",".$ro_hoch;
