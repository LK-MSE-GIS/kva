...
<div class=\"obernav\">
      ...
      <a class=\"obernav_button\" href=\"xant_suchen.php\">Anträge</a>
...
function nav_aendern($id,$db_link,$page,$status)
 {
  ...
  <td><a class=\"nav_aendern\" href=\"xant_searchlist.php?page=$page&highlight=$id&status=$status\">Zurück</a>&nbsp;&nbsp;</td>";
  ...
  echo "<a class=\"nav_aendern\" href=\"xant_aendern_uebernahme.php?id=$id&page=$page&status=$status\">Übernahme</a>&nbsp;&nbsp;</td>";
