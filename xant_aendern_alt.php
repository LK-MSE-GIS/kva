...
nav_aendern_alt($id,$db_link,$page,$status);
...
/*------------ANZEIGEN VON FORHANDENEN DATENSÄTZEN------------*/
   ...
   if ((strpos($abteilung,"old") > -1) OR (strpos($abteilung,"adm") > -1))
     ...
     if ((strpos($abteilung,"adm") > 0) OR (strpos($abteilung,"old") > 0)) echo "<a class=\"x_button\" title=\"Gesamten Datensatz löschen...\" href= \"xant_hist_del.php?id=$id&page=$page&status=$status\">X</a>";
     echo "</td>
     </tr>";
    }
