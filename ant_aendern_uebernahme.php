...
<tr>
 ...
 if ($r[gemark_id_1] > 0)
 {
  ...
  if (((strpos($abteilung,"alk") > -1) OR (strpos($abteilung,"adm") > -1)) AND ($flur_id_1 != '') AND ($r[alk_ja_nein] == '0') AND ($r[aktort_id] == '4')) echo get_gemark_name($r[gemark_id_1],$dbname),":&nbsp;<a href=\"ant_baust_ins.php?flur_id=$flur_id_1&aktenz=$aktenz&mitarb=$username&page=$page&id=$idd&status=$status\"><img src=\"images/traffic.jpg\" alt=\"\" border=\"0\" width=\"25\"></a>";
 echo "<br>";
 }
...
if ($r[gemark_id_2] > 0 AND $r[gemark_id_2] != $r[gemark_id_1])
 {
  ...
  if (((strpos($abteilung,"alk") > -1) OR (strpos($abteilung,"adm") > -1)) AND ($flur_id_2 != '') AND ($r[alk_ja_nein] == '0') AND ($r[aktort_id] == '4')) echo get_gemark_name($r[gemark_id_2],$dbname),":&nbsp;<a href=\"ant_baust_ins.php?flur_id=$flur_id_1&aktenz=$aktenz&mitarb=$username&page=$page&id=$idd&status=$status\"><img src=\"images/traffic.jpg\" alt=\"\" border=\"0\" width=\"25\"></a>";
 echo "<br>";
 }
...
if ($r[gemark_id_3] > 0 AND $r[gemark_id_3] != $r[gemark_id_1] AND $r[gemark_id_3] != $r[gemark_id_2])
 {
  ...
  if (((strpos($abteilung,"alk") > -1) OR (strpos($abteilung,"adm") > -1)) AND ($flur_id_3 != '') AND ($r[alk_ja_nein] == '0') AND ($r[aktort_id] == '4')) echo get_gemark_name($r[gemark_id_1],$dbname),":&nbsp;<a href=\"ant_baust_ins.php?flur_id=$flur_id_1&aktenz=$aktenz&mitarb=$username&page=$page&id=$idd&status=$status\"><img src=\"images/traffic.jpg\" alt=\"\" border=\"0\" width=\"25\"></a>";
 }
