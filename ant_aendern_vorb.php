...
echo "<table><tr>";
if ($r[gemark_id_1] != '0') echo "<td><a href=\"ant_vorb_list.php?gemark_id=$r[gemark_id_1]&flur_id=$r[flur_1]\" target =\"about_blank\">Liste für ",get_gemark_name( $r[gemark_id_1],$dbname),"&nbsp;Flur:$r[flur_1]</a></td><td>&nbsp;</td> ";

if ($r[gemark_id_2] != '0') echo "<td><a href=\"ant_vorb_list.php?gemark_id=$r[gemark_id_2]&flur_id=$r[flur_2]\" target =\"about_blank\">Liste für ",get_gemark_name( $r[gemark_id_2],$dbname),"&nbsp;Flur:$r[flur_2]</a></td><td>&nbsp;</td> ";

if ($r[gemark_id_3] != '0') echo "<td><a href=\"ant_vorb_list.php?gemark_id=$r[gemark_id_3]&flur_id=$r[flur_3]\" target =\"about_blank\">Liste für ",get_gemark_name( $r[gemark_id_3],$dbname),"&nbsp;Flur:$r[flur_3]</a></td> ";
