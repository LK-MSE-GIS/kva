...
if ((strlen($order_case) < 3) OR (strlen($order_addr1) < 1) OR ($order_gem_id < 1))
  {
   ...
   <h3>Aktuellen Auftrag &auml;ndern:&nbsp;&nbsp; $order_key</h3>
   <table>
   <tr>
   <td valign=\"top\">
   <table border=\"0\">
  ...
  <tr>
  <td>PLZ:</td>
  <td><input type=\"Text\" name=\"order_plz\" value=\"$order_plz\" size=\"7\" maxlength=\"7\"></td>
  </tr>
  <tr>
  <td>Ort:</td>
  ...
  $result2=mysql_query($query2);
   ...
   if ($order_status ==1) { echo " <option value=\"1\" slected>eingegangen</option>";}
  ...
  <br>
  <br>
  <input type=\"Submit\" name=\"\" value=\"&Auml;nderungen eintragen\">&nbsp;&nbsp;<input type=\"reset\">&nbsp;&nbsp;&nbsp;<a href=\"order_delete.php?id=$id\">Auftrag $order_key l&ouml;schen</a>
  </form>";
  }
  else
  {

  $changequery="UPDATE orders set
                              order_date='$order_date',
                              order_case='$order_case',
                              order_comment='$order_comment',
                              order_gem_id='$order_gem_id',
                              order_flur='$order_flur',
                              ...
                              calc_prep='$calc_prep',
                              order_status='$order_status' WHERE id = '$id';";


mysql_query($changequery) OR DIE ("Der Eintrag konnte nicht angelegt werden...");

ok();
echo "Die &auml;nderung im Auftrag: ",$order_key," wurde vorgenommen.<br><br>";
echo " <a href=\"order_change.php?id=$id\">[Aktueller Auftrag]</a></div><br> <br> ";
echo "</b>";
