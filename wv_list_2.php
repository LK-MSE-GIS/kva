...
<h2>Werkverträge (ALB-Übernahme)</h2>

<?php

  $query="SELECT oid as id,box(the_geom) as box,bezeichnung,vermessungsstelle,abgabe,status from fd_wv where status='2' ORDER BY bezeichnung;";
